    ...
    <>
      ...
      {open && createPortal(
        <motion.div
          ...
          className="fixed bottom-16 left-1/2 -translate-x-1/2 w-80 bg-[#1A201F]/80 backdrop-blur-xl border border-white/[0.08] rounded-xl shadow-[0_8px_32px_rgba(0,0,0,0.4)] overflow-hidden z-[99999]"
        >
          {/* Header */}
